...
Domain/LearnLab:  Math/Geometry
Tutor:            Cognitive Tutor 1996
Description:      This dataset has the data from the area unit of the Geometry course
                  conducted during the school year 1996-1997.
                  Note: This dataset was created from a file resembling a student-step
...
Knowledge Component Model(s): Area (2 knowledge components)
                              ...
                              LFASearchAICWholeModel0 (17 knowledge components)
                              LFASearchAICWholeModel1 (16 knowledge components)
                              LFASearchAICWholeModel2 (17 knowledge components)
                              LFASearchAICWholeModel3 (18 knowledge components)
                              LFASearchModel0 (10 knowledge components)
                              LFASearchModel1 (11 knowledge components)
                              LFASearchModel1-back-context (13 knowledge components)
                              LFASearchModel1-backward (13 knowledge components)
                              LFASearchModel1-context (12 knowledge components)
                              LFASearchModel1-renamed (11 knowledge components)
                              LFASearchModel1-renamed&chgd (11 knowledge components)
                              LFASearchModel1-renamed&chgd.2 (11 knowledge components)
                              LFASearchModel1-renamed&chgd.3 (11 knowledge components)
                              LFASearchModel1.context-single (19 knowledge components)
                              ...
                              textbook2 (13 knowledge components)
